...
public class GameManager
{
    ...
    public void AddItem(string name, int attack, int armor, string description, string type, int price, bool purchased = false)
    {
        var item = new Item(name, attack, armor, description, type, price, purchased);
        Items.Add(item);
    }
